...
//			view.getTextArea().setText(null); //clear text area from the previous file
			...
			String title = FileUtils.getFileMetadata(dialog.getSelectedFile().getAbsolutePath(),TITLE_METADATA_NAME );
			String author = FileUtils.getFileMetadata(dialog.getSelectedFile().getAbsolutePath(), AUTHOR_METADATA_NAME);
